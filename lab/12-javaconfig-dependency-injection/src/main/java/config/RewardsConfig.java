 ...
 *
 * dTODO-01: Make this class a Spring configuration class
 * - Use an appropriate annotation.
 *
 * dTODO-02: Define four empty @Bean methods, one for the
 ...
 *   - rewardRepository
 *
 * dTODO-03: Inject DataSource through constructor injection
 ...
 *
 * dTODO-04: Implement each @Bean method to contain the code
...
public class RewardsConfig {
	...
	public AccountRepository accountRepository() {
		...
		jdbcAccountRepository.setDataSource(this.dataSource);
	...
	public RestaurantRepository restaurantRepository() {
		...
		jdbcRestaurantRepository.setDataSource(this.dataSource);
