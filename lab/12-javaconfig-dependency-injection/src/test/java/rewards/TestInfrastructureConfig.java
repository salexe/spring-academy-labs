...
/**
 * dTODO-06: Study this configuration class used for testing
 ...
 *
 * dTODO-07: Import your application configuration file (RewardsConfig)
 * - Now the test code should have access to all the beans defined in
 *   the RewardsConfig configuration class
 *
 * dTODO-08: Create a new JUnit 5 test class
 ...
 *
 * dTODO-09: Make sure the setUp() method in the RewardNetworkTests class is annotated with @BeforeEach.
 ...
 *
 * dTODO-10: We can test the setup by running an empty test.
 ...
 *
 * dTODO-11: Finally run a real test.
