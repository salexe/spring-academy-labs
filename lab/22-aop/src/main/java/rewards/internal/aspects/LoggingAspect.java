...
// 	dTODO-02: Use AOP to log a message before
...
public class LoggingAspect {
	...
	// dTODO-03: Write Pointcut Expression
    ...
    // dTODO-07: Use AOP to time update...() methods.
	...
	public Object monitor(ProceedingJoinPoint repositoryMethod) throws Throwable {
		...
		try {
			...
			//  dTODO-08: Add the logic to proceed with the target method invocation.
