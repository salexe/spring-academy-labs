...
public class DBExceptionHandlingAspect {
	...
	//	dTODO-10 (Optional): Use AOP to log an exception.
	...
	@AfterThrowing(value = "execution(* rewards..*Repository.*(..))", throwing = "e")
	public void implExceptionHandling(RewardDataAccessException e) {
		// Log a failure warning
		logger.warn(EMAIL_FAILURE_MSG + e + "\n");
	}

	//	dTODO-11 (Optional): Annotate this class as a Spring-managed bean.
